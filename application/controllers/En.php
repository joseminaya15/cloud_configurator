...
class En extends CI_Controller {
  ...
  public function index(){
    ...
    $data['Tamanio']         = $this->session->userdata('tamanio') == null ? '-' : $this->session->userdata('tamanio').' employees';
  ...
  function sendGmailSap($email){
      ...
      try { 
        ...
        $configGmail = array('protocol'  => 'smtp',
         ...
         $this->email->subject('I am interested in Cloud Configurator for my business.');
         $texto = '<!DOCTYPE html>
                    <html>
                    <head>
                      <title></title>
                                ...
                                <tr>
                                  <table style="padding: 20px;" cellspacing="0" cellpadding="0" border="0">
                                    <tbody>
                                      ...
                                      <tr style="padding: 0 20px;">
                                        <td><font style="margin: 3px 0;font-size: 18px;font-family: "Open Sans",Arial,Helvetica,sans-serif;font-weight: bold;"><strong>Position:</strong></font></td>
                                        <td><font  style="margin: 3px 0;font-family: "Open Sans",Arial,Helvetica,sans-serif;">'.$_SESSION['Cargo'].'</font></td>
                                      </tr>
                                      <tr style="padding: 0 20px;">
                                        <td><font style="margin: 3px 0;font-size: 18px;font-family: "Open Sans",Arial,Helvetica,sans-serif;font-weight: bold !important"><strong>Company:</strong></font></td>
                                        <td><font style="font-family: "Open Sans",Arial,Helvetica,sans-serif;">'.$_SESSION['Empresa'].'</font></td>
                                      </tr>
                                      <tr style="padding: 0 20px;">
                                        <td><font style="margin: 3px 0;font-size: 18px;font-family: "Open Sans",Arial,Helvetica,sans-serif;font-weight: bold;"><strong>Phone:</strong></font></td>
                                        <td><font style="margin: 3px 0;font-family: "Open Sans",Arial,Helvetica,sans-serif;">'.$_SESSION['Telefono'].'</font></td>
                                      </tr>
                                      <tr style="padding: 0 20px;">
                                        <td><font style="margin: 3px 0;font-size: 18px;font-family: "Open Sans",Arial,Helvetica,sans-serif;font-weight: bold;"><strong>E-mail:</strong></font></td>
                                        <td><font style="margin: 3px 0;font-family: "Open Sans",Arial,Helvetica,sans-serif;">'.$_SESSION['Email'].'</font></td>
                                      </tr>
                                      <tr style="padding: 0 20px;">
                                        <td><font style="margin: 3px 0;font-size: 18px;font-family: "Open Sans",Arial,Helvetica,sans-serif;font-weight: bold;"><strong>Relationship with SAP:</strong></font></td>
  ...
  function mostrarDatos(){
      ...
      try {
          ...
          $data['Tamanio']         = $obtenerDatos[0]->tamanio; //$this->session->userdata('tamanio') == null ? '-' : $this->session->userdata('tamanio').' employees';
